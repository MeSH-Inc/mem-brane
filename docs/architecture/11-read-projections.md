...
This projection does not delete checkpoint evidence. Workspace reads still include
full block content and up to 100 recent runs in addition to visible and active runs;
they are not a lazy content-loading protocol.
